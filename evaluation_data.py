...
folder_path = r"D:\FYP\imageConvert\testing\4611"
folder_name = "4611"
output_path = r"D:\FYP\imageConvert\testing\4611\out"

#Set working directory and locate the image
root = r"D:\FYP\imageConvert\testing\4611"
...
with open('test_result' + folder_name + '.csv', 'w', newline='') as test_result:
...
def boxing(itemname, imgcv, predictions):
    ...
    for result in predictions:
        ...
        if confidence > 0.5:
            with open(r"C:\Users\munhe\Dev\darkflow\test_result" + folder_name + ".csv", 'a', newline='') as fd:
